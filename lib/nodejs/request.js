...
function _createRequestCallback(address, encoding, done) {
  return function(err, buffer) {
    ...
    // data == '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.or... (length: 43213)'
    // Buffer is the larget chapter number json, so data somehow becomes html.
 ...
 */
// Basically, it searches the object, find the function, and push it to an array.
  ...
  expires: 'Sat, 26 Jul 1997 05:00:00 GMT' }
      ...
      */
      ...
      if (compression === 'gzip') {
        ...
        // _createRequestCallback(address, encoding, done) === callback
